...
<nav id="navbar" 
    ...
    {{-- PERBAIKAN 1: max-w diperbesar jadi 1440px (atau bisa pakai w-full), padding horizontal ditambah di desktop --}}
    <div class="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 flex justify-between items-center">
        ...
        <a href="/" class="flex items-center space-x-3 md:space-x-4">
            {{-- PERBAIKAN 2: Logo lebih besar di desktop (md:h-12 lg:h-14) --}}
            ...
            {{-- PERBAIKAN 3: Teks brand lebih besar --}}
            <span class="text-2xl md:text-3xl font-black tracking-wider">ENTWO</span>
        </a>

        {{-- Desktop Menu --}}
        {{-- PERBAIKAN 4: Jarak antar menu diperlebar (lg:space-x-12) --}}
        <div class="hidden md:flex space-x-8 lg:space-x-12 items-center">
            {{-- PERBAIKAN 5: Ukuran font menu lebih besar (md:text-lg) --}}
        ...
        {{-- Hamburger Button (Mobile Tetap Sama) --}}
